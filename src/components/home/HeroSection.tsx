  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 -left-32 w-80 h-80 bg-accent/10 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-up">
              Multiplicamos <span className="text-gradient">ações sociais</span>{" "}
              por meio da tecnologia
            </h1>

            <p
              className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-10 animate-fade-up leading-relaxed"
